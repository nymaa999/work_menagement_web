...
const callback$2 = defineEventHandler(async (event) => {
  var _a, _b;
  ...
  try {
    ...
    const user = {
      ...
      avatar: (_b = (_a = userData.picture) == null ? void 0 : _a.data) == null ? void 0 : _b.url
    };
...
const callback$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: callback$2
});
...
const callback = defineEventHandler(async (event) => {
  ...
  try {
    ...
    console.log("Starting Google OAuth process with:", {
      clientId: (clientId == null ? void 0 : clientId.substring(0, 10)) + "...",
      redirectUri,
